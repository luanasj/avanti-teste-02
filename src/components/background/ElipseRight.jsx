const ElipseRight = ({top,right,left})=>{ 

    return(
        <svg className="absolute right-0 top-0" width="634" height="620" viewBox="0 0 634 620" fill="none" xmlns="http://www.w3.org/2000/svg">

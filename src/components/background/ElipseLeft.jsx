const ElipseLeft = ({top,right,left})=>{ 

    return(
        <svg className="absolute left-0 top-[30dvh]" width="259" height="612" viewBox="0 0 259 612" fill="none" xmlns="http://www.w3.org/2000/svg">
